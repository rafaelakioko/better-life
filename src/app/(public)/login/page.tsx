      ...
      <Card className="w-full max-w-md bg-card border-border">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <span className="text-3xl font-bold text-primary">Better Life</span>
          </div>
        ...
        <CardContent className="space-y-4">
          ...
          >
            <Button type="submit" className="w-full bg-white text-gray-900 hover:bg-gray-100 border border-border">
